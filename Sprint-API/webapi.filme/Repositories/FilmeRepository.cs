    ...
    public class FilmeReposiroy : IFilmeRepository
    {
        ...
        public void AtualizarIdCorpo(FilmeDomain filme)
        {
            ...
            using (SqlConnection con = new SqlConnection(StringConexao))
            {
                ...
                string queryUpdate = "UPDATE Filme SET Titulo = @NomeNovo WHERE IdFilme = @IdFilme";
        ...
        public void AtualizarIdUrl(int id, FilmeDomain filme)
        {
            ...
            using (SqlConnection con = new SqlConnection(StringConexao))
            {
                ...
                string queryUpdate = "UPDATE Filme SET Titulo = @Nome WHERE IdFilme = @IdFilme";
        ...
        public FilmeDomain BuscarPorId(int id)
        {
            ...
            using (SqlConnection con = new SqlConnection(StringConexao))
            {
                ...
                //Declara a query que sera executada nesse caso de insercao
                string querySelect = "SELECT IdFilme, Titulo, Nome FROM Filme WHERE IdFilme = @IdFilme";
